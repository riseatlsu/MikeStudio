...
export const TutorialC = {
    id: "tutorial_C",
    title: "Tutorial C: Sense and Decide",
    ...
    objects: {
        stationary: [
            ...
            { type: "pickup_zone", row: 1, col: 2, id: "tutorial_c_input_zone", attributes: { allowDrop: true, frame: 1 } },

            ...createHorizontalConveyor(4, 2, "tutorial_c_output"),
            { type: "dropoff_zone", row: 3, col: 3, id: "tutorial_c_output_zone", attributes: { allowDrop: true, frame: 0 } },

            ...walls,

            // The one obstacle the sense-and-decide loop needs to react to
            { type: "pillars", row: 1, col: 4, id: "tutorial_c_pillar", attributes: { allowDrop: false, frame: 0 } },

            // Decorative clutter
            { type: "OilDrums", row: 5, col: 0, id: "tutorial_c_drum", attributes: { allowDrop: false, frame: 1 } }
        ],
        moveable: [
    ...
    winConditions: [
        { type: "itemAtPos", itemId: "tutorial_c_box", row: 4, col: 3 }
    ],
