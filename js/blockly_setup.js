...
async function executeBlocklyCode() {
  ...
  try {
    await GameAPI.ready(); // garante que o Phaser carregou
...
// Bloco "Pick object"
Blockly.JavaScript['pick_object'] = function(block) {
  return `await GameAPI.toggleTow();\n`;
};

// Bloco "Release object"
Blockly.JavaScript['release_object'] = function(block) {
  return `await GameAPI.toggleTow();\n`;
};
...
Blockly.defineBlocksWithJsonArray([
  {
    ...
    "args0": [
      { "type": "field_number", "name": "STEPS", "value": 1, "min": 1 }
    ],
    "previousStatement": null,
    "nextStatement": null,
    "colour": 160
