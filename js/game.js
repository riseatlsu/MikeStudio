...
// ------------------ Scene ------------------
function preload() {
  this.load.image('tiles', 'phaser-demo/server/assets/tiles.png');
  this.load.image('car',  'phaser-demo/server/assets/spriteOpen_0.png'); // single-frame sprite
  this.load.image('star', 'phaser-demo/server/assets/star.png');         // put a star.png in /assets
}
